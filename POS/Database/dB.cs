...
namespace POS.Database
{
    public class dB
    {
         static string connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\INAM\Downloads\BITF17A535\POS(orignal)\POS(orignal)\POS\POS\Database\DatabasePos.mdf;Integrated Security=True";
